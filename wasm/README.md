...
- Majority of examples will accept following arguments: `node <script> [address] [mainnet|testnet|devnet|simnet] [--address <address>] [--network <mainnet|testnet|devnet|simnet|testnet-<number>>] [--encoding <borsh|json>]`.
